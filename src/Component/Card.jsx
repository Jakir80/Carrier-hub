...
const Card = ({singlecard}) => {
    const {id,company_logo,job_title,company_name,remote_or_onsite,location,fulltime,salary,job_description,job_responsibility,educational_requirements,experiences,contact_information,parttime}=singlecard
    return (
